...
$pdo = new PDO('mysql:host=localhost;dbname=boutique', // Le driver "mysql" + le serveur de la BDD + le nom de la BDD 
...
define('RACINE_SITE','/PHP/08-site/'); // Ici, on indique le dossier dans lequel se trouve le site à partir de "localhost".S'il n'est dans aucun dossier , on met un "/" seul.Permet de créer des chemins absollus à partir de "localhost".Rappel: le "/" au début du chemin caractérise un chemin absolu.
